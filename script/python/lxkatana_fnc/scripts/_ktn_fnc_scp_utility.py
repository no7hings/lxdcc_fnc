...
def set_asset_workspace_create(rsv_task_properties):
    ...
    if branch == 'asset':
        ...
        if current_look_ass_file_path:
            katana_look_workspace = ktn_fnc_builders.AssetWorkspaceBuilder()
            katana_look_workspace.set_workspace_create()
            # geometry
            ...
            if current_geometry_usd_hi_file_path:
                katana_look_workspace.set_geometry_usd_import(current_geometry_usd_hi_file_path)
            # geometry-groom
            ...
            if groom_geometry_usd_file_path:
                katana_look_workspace.set_groom_geometry_usd_import(groom_geometry_usd_file_path)
            # geometry-effect
            ...
            if effect_geometry_usd_file_path:
                katana_look_workspace.set_effect_usd_import(effect_geometry_usd_file_path)
            # default pass
                ...
                if look_pass_names:
                    ...
                    for i_look_pass_name in look_pass_names:
                        ...
                        if i_look_pass_name != 'default':
                            katana_look_workspace.set_pass_add(i_look_pass_name)
    ...
    if branch == 'asset':
        ...
        if look_ass__surface_anm__file_path:
            ...
            if surface_geometry_usd_hi_file_path:
                katana_look_workspace.set_geometry_usd_import(surface_geometry_usd_hi_file_path)
            # geometry-groom
            groom_geometry_usd_file_path = rsv_operators.RsvAssetUsdQuery(rsv_task_properties).get_groom_registry_file()
            if groom_geometry_usd_file_path:
                katana_look_workspace.set_groom_geometry_usd_import(groom_geometry_usd_file_path)
